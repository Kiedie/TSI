...
import Herrera_Aranda_Juan_Jose.*;
...
public class Test {
    ...
    public static void main(String[] args) {
		...
		String sampleOLETSController = "tracks.singlePlayer.advanced.olets.Agent";
                ...
                String myController_CamelRace = "tracks.singlePlayer.myAgent_Camel";
                String myPractica = "Herrera_Aranda_Juan_Jose.Agent";
		...
		// 2. This plays a game in a level by the controller.
                ...
                int num_ejecuciones = 20;
                for(int i = 0 ; i < num_ejecuciones; i++){
                    seed = new Random().nextInt();
                    ArcadeMachine.runOneGame(game, level1, visuals, myPractica, recordActionsFile, seed, 0);
                }
